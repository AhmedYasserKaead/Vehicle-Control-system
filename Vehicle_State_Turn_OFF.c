...
void Vehicle_Current_State_Turn_OFF(u_int8 *Engine_state, u_int8 *AC, u_int16 *speed, f_32 *room_temp, f_32 *engine_temp, u_int8 *Engine_Temperature_Controller){
	...
	printf("Engine Temperature %0.2f degree and decreasing.\n\n", *engine_temp);		/* Show the engine temperature. */
